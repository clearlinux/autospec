...
class FileManager(object):
    ...
    def push_file(self, filename, pkg_name):
        ...
        patterns = [
            ...
            (r"^/usr/clear/optimized-elf/bin", "bin", "/usr/clear/optimized-elf/bin*"),
            (r"^/usr/clear/optimized-elf/exec", "libexec", "/usr/clear/optimized-elf/exec*"),
            (r"^/usr/clear/optimized-elf/lib", "lib", "/usr/clear/optimized-elf/lib*"),
            (r"^/usr/clear/optimized-elf/", "lib"),
            (r"^/usr/clear/filemap/", "filemap"),
